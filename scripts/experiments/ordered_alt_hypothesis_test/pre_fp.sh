...
#   main_fp.sh 실행에 앞서 안정적인 draws 최솟값 탐색
#   chains=1, thin=1 고정
...
#
# 사용법:
#   bash scripts/experiments/ordered_alt_hypothesis_test/pre_fp.sh
#   MAX_JOBS=3 bash scripts/experiments/ordered_alt_hypothesis_test/pre_fp.sh
...
main() {
    ...
    echo "=================================================="
    echo "사전 실험: FP draws 탐색 (median 안정성 기준)"
